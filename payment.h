...
if((strcmp(origin,"MUMBAI")==0)||(strcmp(origin,"BANGLORE")==0)&&(strcmp(destination,"MUMBAI")==0)||(strcmp(destination,"BANGLORE")==0))
...
else if((strcmp(origin,"MUMBAI")==0)||(strcmp(origin,"KOCHI")==0)&&(strcmp(destination,"MUMBAI")==0)||(strcmp(destination,"KOCHI")==0))
	return payment=10101;
else if((strcmp(origin,"MUMBAI")==0)||(strcmp(origin,"CHENNAI")==0)&&(strcmp(destination,"MUMBAI")==0)||(strcmp(destination,"CHENNAI")==0))
	return payment=10101;
else if((strcmp(origin,"BANGLORE")==0)||(strcmp(origin,"HYDERABAD")==0)&&(strcmp(destination,"BANGLORE")==0)||(strcmp(destination,"HYDERABAD")==0))
	payment=33930;
else if((strcmp(origin,"BANGLORE")==0)||(strcmp(origin,"KOCHI")==0)&&(strcmp(destination,"BANGLORE")==0)||(strcmp(destination,"KOCHI")==0))
	return payment=60000;
else if((strcmp(origin,"BANGLORE")==0)||(strcmp(origin,"CHENNAI")==0)&&(strcmp(destination,"BANGLORE")==0)||(strcmp(destination,"CHENNAI")==0))
	return payment=93798;
else if((strcmp(origin,"HYDERABAD")==0)||(strcmp(origin,"KOCHI")==0)&&(strcmp(destination,"HYDERABAD")==0)||(strcmp(destination,"KOCHI")==0))
	return payment=73702;
else if((strcmp(origin,"HYDERABAD")==0)||(strcmp(origin,"CHENNAI")==0)&&(strcmp(destination,"HYDERABAD")==0)||(strcmp(destination,"CHENNAI")==0))
